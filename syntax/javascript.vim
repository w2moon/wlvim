...
syntax match javaScriptCallPattern /[a-zA-Z_]\w*\s*(/ contains=javaScriptCall,javaScriptCallParens

" Braces, Parens, symbols, colons 
syntax match javaScriptSeparator /:/
...
if version >= 508 || !exists("did_javascript_syn_inits")
	...
	HiLink javaScriptSeparator              Operator
  ...
  HiLink javascriptTemplate               String
	...
	HiLink javaScriptCall                  Function
